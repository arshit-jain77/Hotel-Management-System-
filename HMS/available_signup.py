...
class Ui_Form16(object):
    ...
    def details(self):
        ...
        from details_signup import Ui_Form0
        self.ui = Ui_Form0()
    ...
    def click(self):
        ...
        availability_of_rooms = {}
        availability_of_rooms['Single']=single
        availability_of_rooms['Double']=double
        availability_of_rooms['Triple']=triple
        availability_of_rooms['Quadraple']=quadraple
        availability_of_rooms['Queen']=queen
        availability_of_rooms['King']=king

        firebaseRef = firebase.FirebaseApplication("https://dbms-1bbf5.firebaseio.com/.json", None)
        firebaseRef.post('https://dbms-1bbf5.firebaseio.com/Details_Of_Availability_of_rooms',availability_of_rooms)
